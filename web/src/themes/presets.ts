...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "ViloForge Teal",
  description: "Classic dark teal — the canonical ViloForge look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" ViloForge look, ported from the
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "ViloForge Teal (Large)",
  description: "ViloForge Teal with bigger fonts and roomier spacing",
