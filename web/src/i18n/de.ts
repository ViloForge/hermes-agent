...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateHermes: "ViloForge aktualisieren",
    updatingHermes: "ViloForge wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "ViloForge-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `hermes plugins`).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare ViloForge-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "ViloForge-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze ViloForge mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald ViloForge ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "ViloForge scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
