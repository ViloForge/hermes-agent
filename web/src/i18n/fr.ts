...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateHermes: "Mettre à jour ViloForge",
    updatingHermes: "Mise à jour de ViloForge…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins ViloForge (parité avec `hermes plugins`).",
  ...
  achievements: {
    hero: {
      ...
      title: "ViloForge Achievements",
      subtitle:
        "Badges ViloForge à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions ViloForge en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez ViloForge davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'ViloForge détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "ViloForge analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in ViloForge Agent ☤",
    },
  },
  kanban: {
