...
export const en: Translations = {
  ...
  status: {
    ...
    updatingHermes: "Updating ViloForge…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update ViloForge plugins (`hermes plugins` parity).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible ViloForge badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning ViloForge session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run ViloForge more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once ViloForge sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "ViloForge is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
