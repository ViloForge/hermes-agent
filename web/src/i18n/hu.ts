...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateHermes: "ViloForge frissítése",
    updatingHermes: "ViloForge frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "ViloForge-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `hermes plugins` paritás).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető ViloForge-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "ViloForge munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a ViloForge kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A ViloForge egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
