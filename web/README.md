# ViloForge Agent — Web UI

Browser-based dashboard for managing ViloForge Agent configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “ViloForge Agent” — mixed case, no Mondwest, no `text-display` |
