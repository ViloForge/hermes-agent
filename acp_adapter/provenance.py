...
This is an additive ViloForge extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal ViloForge head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal ViloForge DB session id
