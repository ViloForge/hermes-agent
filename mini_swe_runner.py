#!/usr/bin/env python3
"""
SWE Runner with ViloForge Trajectory Format

A runner that uses ViloForge-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the ViloForge-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses ViloForge-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in ViloForge format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches ViloForge-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using ViloForge-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with ViloForge Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses ViloForge-Agent's built-in execution environments
    and outputs trajectories in ViloForge-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to ViloForge trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to ViloForge trajectory format
...
def main(
    ...
    """
    Run SWE tasks with ViloForge trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with ViloForge Trajectory Format")
    print("=" * 60)
