...
test('desktop backend PATH adds ViloForge-managed bins and missing POSIX sane entries', () => {
...
test('normalizeHermesHomeRoot maps profile homes back to the global ViloForge root', () => {
  assert.equal(
