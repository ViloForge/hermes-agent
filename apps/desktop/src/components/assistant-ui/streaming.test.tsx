...
describe('assistant-ui streaming renderer', () => {
  ...
  it('renders assistant text incrementally before completion', async () => {
    ...
    expect(screen.getByRole('status', { name: 'ViloForge is loading a response' })).toBeTruthy()
    ...
    expect(screen.queryByRole('status', { name: 'ViloForge is loading a response' })).toBeNull()
