...
export const en: Translations = {
  ...
  boot: {
    ready: 'ViloForge Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading ViloForge settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting ViloForge Desktop…'
    },
    errors: {
      backgroundExited: 'ViloForge background process exited.',
      backgroundExitedDuringStartup: 'ViloForge background process exited during startup.',
    ...
    failure: {
      title: "ViloForge couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your ViloForge backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update ViloForge',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting ViloForge Desktop.',
    ...
    native: {
      ...
      inputBody: 'ViloForge is waiting for your response.',
      turnDoneTitle: 'ViloForge finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to ViloForge defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while ViloForge is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'ViloForge asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while ViloForge was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let ViloForge follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what ViloForge is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen ViloForge, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'ViloForge checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading ViloForge configuration...',
    ...
    gateway: {
      ...
      intro:
        'ViloForge Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running ViloForge backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private ViloForge backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote ViloForge backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'ViloForge Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · ViloForge ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. ViloForge runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart ViloForge to use pets — the backend predates this feature.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure ViloForge desktop' },
    ...
    hermesActiveSessions: (version, count) => `ViloForge ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent ViloForge environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. ViloForge will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting ViloForge...',
    placeholderReconnecting: 'Reconnecting to ViloForge…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give ViloForge a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'ViloForge will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating ViloForge…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting ViloForge…',
    ...
    unsupportedMessage: 'This version of ViloForge can’t update itself from inside the app.',
    ...
    manualBody: 'You installed ViloForge from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'ViloForge will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the ViloForge desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The ViloForge updater takes over in its own window and reopens ViloForge automatically when it’s done. Please don’t reopen ViloForge yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. ViloForge reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then ViloForge reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'ViloForge needs a one-time install',
    ...
    settingUpTitle: 'Setting up ViloForge Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another ViloForge CLI or desktop instance is running. Stop any running ViloForge instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The ViloForge installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with ViloForge Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'ViloForge is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting ViloForge…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run ViloForge',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point ViloForge at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — ViloForge connects automatically',
      loopback: 'Opens your browser to sign in — ViloForge connects automatically',
    ...
    authorizeThere: 'Authorize ViloForge there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize ViloForge there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'ViloForge inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. ViloForge will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'ViloForge is restarting...',
      askRestart: 'Ask ViloForge to restart the server',
      lookingRestart: taskId => `ViloForge is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'ViloForge is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `ViloForge finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'ViloForge could not restart the server.',
      stillWorking:
        'ViloForge is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'ViloForge is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'ViloForge gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). ViloForge won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'ViloForge needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'ViloForge needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart ViloForge Desktop to use Save Image.',
    restartToSaveImages: 'Restart ViloForge Desktop to save images',
