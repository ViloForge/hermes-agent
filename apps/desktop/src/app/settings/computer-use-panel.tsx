 ...
 * cua-driver's own `com.trycua.driver` identity — not ViloForge — and are
        ...
        <div className="min-w-0">
          {status.can_grant ? (
            <p className="text-[0.72rem] text-muted-foreground">
              Grants attach to CuaDriver&apos;s own identity (com.trycua.driver), not ViloForge — so the dialog is
