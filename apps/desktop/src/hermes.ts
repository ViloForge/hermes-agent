...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'ViloForge gateway connection closed',
      connectErrorMessage: 'Could not connect to ViloForge gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'ViloForge gateway is not connected',
