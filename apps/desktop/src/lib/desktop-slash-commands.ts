...
/** Why a known ViloForge command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active ViloForge profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show ViloForge Agent version', surface: exec() },
 ...
 * ViloForge' built-in slash commands — i.e. skill commands (`/gif-search`,
