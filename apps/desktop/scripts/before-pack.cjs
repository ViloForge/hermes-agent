 ...
 * product name (`ViloForge`). If a PREVIOUS `npm run pack` was interrupted
 ...
 *   '.../release/linux-unpacked/electron' -> '.../release/linux-unpacked/ViloForge'
 *
 ...
 * (the mac-unpacked ViloForge.app bundle) and Windows (win-unpacked), so we
