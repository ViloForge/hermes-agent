...
There are two ways to add a platform to the ViloForge gateway:
...
**zero changes to core ViloForge code**.
...
Checklist for integrating a platform directly into the ViloForge core.
