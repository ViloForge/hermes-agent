...
- GET  /api/sessions               — list client-visible ViloForge sessions
- POST /api/sessions               — create an empty ViloForge session
...
def _derive_chat_session_id(
    ...
    the same ViloForge session (and therefore the same Docker container sandbox
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    async def _handle_capabilities(self, request: "web.Request") -> "web.Response":
        ...
        every ViloForge version exposes the same endpoints.
        """
        auth_err = self._check_auth(request)
        if auth_err:
            return auth_err
        ...
        return web.json_response({
            ...
            "runtime": {
                ...
                "split_runtime": False,
                "description": (
                    "The API server creates a server-side ViloForge AIAgent; "
    ...
    async def _handle_list_sessions(self, request: "web.Request") -> "web.Response":
        """GET /api/sessions — list persisted ViloForge sessions."""
        auth_err = self._check_auth(request)
        if auth_err:
            return auth_err
    ...
    async def _handle_create_session(self, request: "web.Request") -> "web.Response":
        """POST /api/sessions — create an empty ViloForge session row."""
        auth_err = self._check_auth(request)
        if auth_err:
            return auth_err
    ...
    async def _handle_chat_completions(self, request: "web.Request") -> "web.Response":
        ...
        if provided_session_id:
            ...
            # conversation map to the same ViloForge session.  The first user
        ...
        # truncation via finish_reason="length" + ViloForge-specific extras.
        response_data = {
            "id": completion_id,
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # Store the adapter after native routes are registered. Local ViloForge-Relay
