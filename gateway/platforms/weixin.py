...
Connects ViloForge Agent to WeChat personal accounts via Tencent's iLink Bot API.
...
class WeixinAdapter(BasePlatformAdapter):
    """Native ViloForge adapter for Weixin personal accounts."""
    ...
    async def connect(self) -> bool:
        ...
        if self._group_policy != "disabled":
            logger.warning(
                ...
                "these accounts, so group messages may never reach ViloForge regardless of this "
