...
# xAI's public API is OpenAI-compatible for the endpoints ViloForge commonly
# uses. The Responses endpoint is included because ViloForge' native xAI runtime
...
class XAIGrokAdapter(UpstreamAdapter):
    """Proxy upstream for xAI Grok via ViloForge-managed OAuth credentials."""
