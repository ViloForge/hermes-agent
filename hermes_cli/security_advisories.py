"""
Security advisory checker for ViloForge Agent.
...
run in environments where the rest of ViloForge failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — ViloForge requires 3.10+ but defensive.
        return None
    try:
