...
_VALID_API_MODES = {
    ...
    # instead of ViloForge' tool dispatch. Gated behind config key
    ...
    *,
    ...
    if provider == "anthropic":
        ...
        if _is_azure_endpoint:
            ...
            # chain.  Accept both `key_env` (ViloForge canonical — matches the
            # custom_providers field name) and `api_key_env` (documented in the
            # Azure Foundry guide and read by most ViloForge-compatible importers).
