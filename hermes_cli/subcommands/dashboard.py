...
def build_dashboard_parser(
    ...
    dashboard_parser = subparsers.add_parser(
        ...
        description="Launch the ViloForge Agent web dashboard for managing config, API keys, and sessions",
    )
    ...
    # Backward-compat shim: older ViloForge desktop app shells (<= 0.15.x) spawn the
    ...
    # showed "ViloForge couldn't start" with no actionable cause. Accept and silently
