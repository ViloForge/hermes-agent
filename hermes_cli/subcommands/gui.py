...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description=(
            "Launch the ViloForge Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        "--hermes-root",
        help="Override the ViloForge source root used by Desktop (sets HERMES_DESKTOP_HERMES_ROOT)",
    )
    gui_parser.add_argument(
        "--cwd",
