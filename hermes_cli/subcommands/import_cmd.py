...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a ViloForge backup from a zip file",
        description="Extract a previously created ViloForge backup into your "
        "ViloForge home directory, restoring configuration, skills, "
        "sessions, and data",
    )
