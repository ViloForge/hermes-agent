"""ViloForge CLI skin/theme engine.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "ViloForge Agent"       # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ ViloForge "    # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "ViloForge Agent"
...
- ``default`` — Classic ViloForge gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic ViloForge — gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to ViloForge Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ ViloForge ",
            "prompt_symbol": "❯",
