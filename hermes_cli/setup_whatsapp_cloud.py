...
ViloForge gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures ViloForge to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  ViloForge needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the ViloForge gateway in another terminal:")
