...
TIPS = [
    ...
    "Ctrl+Z suspends ViloForge to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs ViloForge itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire ViloForge home directory.",
    ...
    "hermes gateway install sets up ViloForge as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call ViloForge tools programmatically — results stay out of context.",
    ...
    "When exiting, ViloForge prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "ViloForge runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to ViloForge via a local macOS server.",
    ...
    "ViloForge loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs ViloForge as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make ViloForge your own.",
    ...
    "Before a gateway session reset, ViloForge auto-flushes important facts to memory in the background.",
    ...
    "Profiles scope ViloForge state via HERMES_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — ViloForge auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of ViloForge config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while ViloForge is working.',
    ...
    'hermes dashboard embeds the full ViloForge TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes ViloForge block commands when the tirith scanner itself errors out.',
