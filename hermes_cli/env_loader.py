"""Helpers for loading ViloForge .env files consistently across entrypoints."""
...
def _sanitize_env_file_if_needed(path: Path) -> None:
    ...
    already knows all valid ViloForge env-var names and can split
...
def load_hermes_dotenv(
    *,
    ...
    """Load ViloForge environment files with user config taking precedence.
...
def _apply_external_secret_sources(home_path: Path) -> None:
    ...
    locate the access token) but BEFORE the rest of ViloForge reads
