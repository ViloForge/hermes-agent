"""``hermes debug`` debug tools for ViloForge Agent.
...
⚠️  This will upload the following to a public paste service:
  • System info (OS, Python version, ViloForge version, provider, which API keys
...
def run_debug_share(args):
    ...
    print(f"\nShare these links with the ViloForge team for support.")
