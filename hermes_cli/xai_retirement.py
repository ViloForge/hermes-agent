...
Pure logic: walks a ViloForge config dict, returns issues for any reference
...
class RetirementIssue:
    """A reference to a retired xAI model found in a ViloForge config."""
...
def find_retired_xai_refs(config: Dict[str, Any]) -> List[RetirementIssue]:
    """Walk all model slots in a ViloForge config and return retirement issues.
