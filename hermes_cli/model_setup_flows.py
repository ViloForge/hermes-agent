...
def _model_flow_custom(config):
    ...
    if probe.get("used_fallback") and probe.get("resolved_base_url"):
        ...
        print(
            ...
            f"ViloForge will still save it."
        )
...
def _model_flow_azure_foundry(config, current_model=""):
    ...
    * Manual entry when every probe fails (private endpoints, etc.).
    ...
    print("Anthropic-style API endpoints.  ViloForge will probe your")
    ...
    if use_entra:
        ...
        if not has_azure_identity_installed():
            ...
            print(
                "  ViloForge will install it now (the preflight below "
...
def _model_flow_copilot_acp(config, current_model=""):
    ...
    print("  GitHub Copilot ACP delegates ViloForge turns to `copilot --acp`.")
    print("  ViloForge currently starts its own ACP subprocess for each request.")
    print("  ViloForge uses your selected model as a hint for the Copilot ACP session.")
    ...
    if provider_id == "gemini" and existing_key:
        ...
        if probe_gemini_tier is not None:
            ...
            if tier == "free":
                ...
                print(
                    "   ViloForge typically makes 3-10 API calls per user turn "
                ...
                print()
                print(
                    "   To use Gemini with ViloForge, enable billing on your "
