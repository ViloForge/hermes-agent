"""
Microsoft Teams platform adapter for ViloForge Agent.
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "ViloForge"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"ViloForge\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
