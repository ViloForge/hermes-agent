...
Credential storage mirrors every other ViloForge channel:
...
# registers ViloForge as its own client_id.
...
# Default name of the project ViloForge provisions for the operator.
DEFAULT_PROJECT_NAME = "ViloForge Agent"
...
def _auth_json_path() -> Path:
    """Resolve ``~/.hermes/auth.json`` honouring the active ViloForge profile."""
    try:
