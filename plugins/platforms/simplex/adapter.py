"""SimpleX Chat platform adapter (ViloForge plugin).
...
``plugins/platforms/simplex/``. The ViloForge plugin loader scans the
...
# Imported at module top because they're stdlib-only inside ViloForge — no
