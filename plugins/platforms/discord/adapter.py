...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _handle_bot_task_done(self, task: asyncio.Task) -> None:
        ...
        marked running, the Discord websocket is dead while the ViloForge gateway
    ...
    def _canonicalize_app_command_payload(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Reduce command payloads to the semantic fields ViloForge manages."""
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your ViloForge session")
        ...
        @tree.command(name="status", description="Show ViloForge session status")
        ...
        @tree.command(name="stop", description="Stop the running ViloForge agent")
        ...
        @tree.command(name="update", description="Update ViloForge Agent to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="restart", description="Gracefully restart the ViloForge gateway")
        ...
        @tree.command(name="thread", description="Create a new thread and start a ViloForge session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to ViloForge in the thread",
    ...
    def _register_skill_group(self, tree) -> None:
        ...
        try:
            ...
            cmd = discord.app_commands.Command(
                name="skill",
                description="Run a ViloForge skill",
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new ViloForge session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by ViloForge: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "ViloForge"
        if len(content) > 80:
        ...
        try:
            ...
            try:
                seed_msg = await message.channel.send(f"\U0001f9f5 Thread created by ViloForge: **{thread_name}**")
                thread = await seed_msg.create_thread(
                    name=thread_name,
    ...
    async def create_handoff_thread(
        ...
        reason = "ViloForge session handoff"
        ...
        try:
            ...
            if send is None:
                return None
            seed_msg = await send(f"\U0001f9f5 ViloForge handoff: **{thread_name}**")
            thread = await seed_msg.create_thread(
                name=thread_name,
                auto_archive_duration=1440,
                reason=reason,
    ...
    async def send_clarify(
        ...
        try:
            ...
            embed = discord.Embed(
                title="❓ ViloForge needs your input",
                description=body,
                color=discord.Color.orange(),
            )
...
def register(ctx) -> None:
    """Plugin entry point — called by the ViloForge plugin system."""
