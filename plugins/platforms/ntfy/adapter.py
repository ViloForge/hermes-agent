"""ntfy platform adapter (ViloForge plugin).
...
a ViloForge dependency.

This adapter ships as a ViloForge platform plugin under
``plugins/platforms/ntfy/``. The ViloForge plugin loader scans the
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a ViloForge dependency",
