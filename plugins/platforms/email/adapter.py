"""
Email platform adapter for the ViloForge gateway.

Allows users to interact with ViloForge by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "ViloForge Agent")
