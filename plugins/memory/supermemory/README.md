...
it groups ViloForge-written memories into a dedicated "ViloForge" Space in the
...
Use `{identity}` in the `container_tag` to scope memories per ViloForge profile:
