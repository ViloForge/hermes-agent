...
# The loopback redirect registered for the ViloForge OAuth client. IP-literal so
...
_CALLBACK_HTML = (
    ...
    b"<div>Connected to Honcho. You can close this tab and return to ViloForge.</div>"
)
