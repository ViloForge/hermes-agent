...
TOOLSETS = {
    ...
    # Coding posture (base ViloForge — CLI/TUI/desktop/ACP). Auto-selected in a
    ...
    # ==========================================================================
    # Full ViloForge toolsets (CLI + messaging platforms)
    #
    ...
    "hermes-email": {
        "description": "Email bot toolset - interact with ViloForge via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-sms": {
        "description": "SMS bot toolset - interact with ViloForge via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
