...
class TestQueryLocalContextLengthOllama:
    ...
    def test_ollama_num_ctx_wins_over_model_info(self):
        ...
        training max — using it would let ViloForge grow conversations past
        ...
        ViloForge used 40960 it would let the conversation grow past 32768
        ...
        assert result == 32768, (
            ...
            "If ViloForge uses the GGUF training max, conversations will silently truncate."
        )
