...
Under a gateway (Telegram, Discord, Slack, ...) ViloForge passes the
...
class TestCrossPlatformMemoryUnification:
    """The same physical user talking to ViloForge via Telegram AND Discord
...
class TestProfilePeerUniqueness:
    """Each ViloForge profile can pin to its own unique peerName.
