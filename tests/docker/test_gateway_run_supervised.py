...
def test_supervised_gateway_stdout_reaches_docker_logs(
    ...
    a poor user experience: the iconic "ViloForge Gateway Starting…"
    ...
    assert "⚕" in combined or "ViloForge Gateway Starting" in combined, (
    ...
    assert "⚕" in file_contents or "ViloForge Gateway Starting" in file_contents, (
