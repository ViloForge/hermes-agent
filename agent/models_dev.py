...
# ---------------------------------------------------------------------------
# Provider ID mapping: ViloForge ↔ models.dev
# ---------------------------------------------------------------------------

# ViloForge provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → ViloForge (built lazily)
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a ViloForge provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal ViloForge agent traffic.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a ViloForge provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve ViloForge ID → models.dev ID
...
def get_model_info(
    ...
    Accepts ViloForge or models.dev provider ID.  Tries exact match then
