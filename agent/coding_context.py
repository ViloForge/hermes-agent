"""Coding-context awareness — base ViloForge, every interactive surface.

When the user runs ViloForge inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), ViloForge shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether ViloForge should operate in its coding posture right now."""
