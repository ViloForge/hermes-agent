...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  ViloForge never re-renders parts of this string mid-
    ...
    # Pointer to the hermes-agent skill + docs for user questions about ViloForge itself.
    ...
    # Coding posture (base ViloForge, any interactive coding surface in a code
    ...
    # Active-profile hint — names the ViloForge profile the agent is running
    ...
    if active_profile == "default":
        stable_parts.append(
            "Active ViloForge profile: default. Other profiles (if any) live "
        ...
        stable_parts.append(
            f"Active ViloForge profile: {active_profile}. This session reads "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — ViloForge never rebuilds or reinjects parts of it
