...
def _resolve_requests_verify() -> bool | str:
    ...
    by default. ViloForge also honours HERMES_CA_BUNDLE (its own convention)
...
# Minimum context length required to run ViloForge Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent ViloForge from probing-down to
...
_URL_TO_PROVIDER: Dict[str, str] = {
    ...
    # (often 8K) makes it unusable for ViloForge' system prompt, but mapping
        ...
        with httpx.Client(timeout=3.0, headers=headers) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # ViloForge grow conversations past the runtime limit and Ollama
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets ViloForge sends to providers:
