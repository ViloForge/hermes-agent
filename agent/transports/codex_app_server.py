...
projection into ViloForge' display, approval bridging, transcript projection into
...
"codex_app_server"`. ViloForge' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def initialize(
        ...
        client_title: str = "ViloForge Agent",
