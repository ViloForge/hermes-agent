...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # through ViloForge's agent loop.
        #
        ...
        # that would silently route around ViloForge's web-provider config and
        ...
        # native search engine for xAI sessions instead of ViloForge's
        # configured web provider (Tavily/etc.), and those results bypass
        # ViloForge's tool-trace / citation plumbing (they arrive baked into the
