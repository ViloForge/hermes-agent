"""Lightweight internationalization (i18n) for ViloForge static user-facing messages.

Scope (thin slice, by design): only the highest-impact static strings shown
to the user by ViloForge itself -- approval prompts, a handful of gateway slash
