...
an 8-column × 9-row atlas; older ViloForge/petdex sheets used an 8-row atlas.
ViloForge infers the row taxonomy from the sheet and maps agent activity onto
