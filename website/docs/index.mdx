...
slug: /
sidebar_position: 0
title: "ViloForge Agent Documentation"
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend ViloForge safely  |
| 🧭 **[Use MCP with ViloForge](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with ViloForge](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for ViloForge voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define ViloForge' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of ViloForge                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind ViloForge, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind ViloForge, Nomos, and Psyche models
