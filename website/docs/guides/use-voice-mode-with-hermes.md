---
sidebar_position: 8
title: "Use Voice Mode with ViloForge"
description: "A practical guide to setting up and using ViloForge voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with ViloForge
...
- you want ViloForge sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in ViloForge.
...
## Step 1: make sure normal ViloForge works first
...
ViloForge supports both local and cloud speech stacks.
...
4. ViloForge transcribes and responds
...
- asking ViloForge to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full ViloForge loop.

## Tuning CLI behavior

### Silence threshold

If ViloForge starts/stops too aggressively, tune:
...
ViloForge stays a normal chat bot, but can speak replies.
...
- you want ViloForge to function like a portable research or ops assistant
...
ViloForge joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- ViloForge detects speech boundaries
- transcripts are posted in the associated text channel
- ViloForge responds in text and audio
