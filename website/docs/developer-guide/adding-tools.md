...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to ViloForge Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in ViloForge tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying ViloForge core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a ViloForge Plugin](/guides/build-a-hermes-plugin)
