---
title: "ViloForge S6 Container Supervision"
sidebar_label: "ViloForge S6 Container Supervision"
description: "Modify, debug, or extend the s6-overlay supervision tree inside the ViloForge Agent Docker image — adding new services, debugging profile gateways, understandin..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# ViloForge S6 Container Supervision

Modify, debug, or extend the s6-overlay supervision tree inside the ViloForge Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern.
...
# ViloForge s6-overlay Container Supervision

## When to use this skill

Load this skill when you're working on:
- Adding or removing a static service in the ViloForge Docker image (something that should be supervised at every container start, like the dashboard)
...
If you're just running the ViloForge Agent and want to use Docker, see `website/docs/user-guide/docker.md` instead.
...
- `hermes-tool-quirks`: Specific ViloForge-tool workarounds (sed/grep/etc.) — load when debugging the s6 stack's interaction with hermes built-in tools.
