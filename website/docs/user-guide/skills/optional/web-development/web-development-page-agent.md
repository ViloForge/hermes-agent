...
- User wants **ViloForge itself to drive a browser** → use ViloForge' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
