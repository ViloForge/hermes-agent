...
| Version | `1.0.0` |
| Author | ViloForge Agent (adapted from gsd-build/get-shit-done) |
| License | MIT |
...
**Verify variants visually — use ViloForge' browser tools.** Don't just write HTML and hope it renders; load each variant and look at it:
