...
curl -s -X POST \
  ...
  -d "{
    \"commit_id\": \"$HEAD_SHA\",
    \"event\": \"COMMENT\",
    \"body\": \"Code review from ViloForge Agent\",
    \"comments\": [
...
gh pr review $PR_NUMBER --approve --body "Reviewed by ViloForge Agent. Code looks clean — good test coverage, no security concerns."
