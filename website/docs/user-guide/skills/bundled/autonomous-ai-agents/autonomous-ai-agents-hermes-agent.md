---
title: "ViloForge Agent — Configure, extend, or contribute to ViloForge Agent"
sidebar_label: "ViloForge Agent"
...
Configure, extend, or contribute to ViloForge Agent.
...
If ViloForge reports a smaller context window than your local model supports
(e.g., 128k when llama-server has `-c 262144`):

**Check if `model.context_length` is explicitly set.** ViloForge uses a
