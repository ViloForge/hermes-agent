...
description: "Operate the Teams meeting summary pipeline via ViloForge CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions"
---
...
Operate the Teams meeting summary pipeline via ViloForge CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions.
