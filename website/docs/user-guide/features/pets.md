...
ViloForge can show an animated **pet** — a small mascot sprite that reacts to what
...
In the terminal (CLI/TUI), ViloForge renders the sprite at full fidelity when your
...
always-on-top desktop window. Out there it stays visible while ViloForge is
