...
Type `@` followed by a reference to inject content directly into your message. ViloForge expands the reference inline and appends the content under an `--- Attached Context ---` section.
