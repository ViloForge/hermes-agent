...
description: "How ViloForge Agent remembers across sessions — MEMORY.md, USER.md, and session search"
---

# Persistent Memory

ViloForge Agent has bounded, curated memory that persists across sessions. This lets it remember your preferences, your projects, your environment, and things it has learned.
...
or update a skill. This is ViloForge' consent-aware learning loop: repeated
...
For deeper, persistent memory that goes beyond MEMORY.md and USER.md, ViloForge ships with 8 external memory provider plugins — including Honcho, OpenViking, Mem0, Hindsight, Holographic, RetainDB, ByteRover, and Supermemory.
