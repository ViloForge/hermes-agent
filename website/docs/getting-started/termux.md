...
description: "Run ViloForge Agent directly on an Android phone with Termux"
---

# ViloForge on Android with Termux

This is the tested path for running ViloForge Agent directly on an Android phone through [Termux](https://termux.dev/).
...
That does not stop ViloForge from working well as a phone-native CLI agent — it just means the recommended mobile install is intentionally narrower than the desktop/server install.

---

## Option 1: One-line installer

ViloForge now ships a Termux-aware installer path:
