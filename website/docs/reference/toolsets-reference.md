...
description: "Reference for ViloForge core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call ViloForge tools programmatically. |
