#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the ViloForge docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use ViloForge as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with ViloForge", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with ViloForge", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with ViloForge", None),
        ("guides/build-a-hermes-plugin", "Build a ViloForge Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with ViloForge"),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# ViloForge Agent — Full Documentation\n",
        (
            "This file is the entire ViloForge Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using ViloForge, Features, Messaging, Integrations, Guides, "
