"""
Timezone-aware clock for ViloForge.
...
Invalid timezone values log a warning and fall back safely — ViloForge never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — ViloForge requires 3.9+)
