#!/usr/bin/env python3
"""
SQLite State Store for ViloForge Agent.
...
class SessionDB:
    ...
    def search_sessions_by_id(
        ...
        a session id from logs, CLI output, or another ViloForge surface and jump
    ...
    def apply_telegram_topic_migration(self) -> None:
        ...
        reconciliation. Operators must be able to upgrade ViloForge, keep the old
    ...
    def bind_telegram_topic(
        ...
        *,
        ...
        """Bind one Telegram DM topic thread to one ViloForge session.

        A ViloForge session may only be linked to one Telegram topic in MVP.
    ...
    def is_telegram_session_linked_to_topic(self, *, session_id: str) -> bool:
        """Return True if a ViloForge session is already bound to any Telegram DM topic.
