...
Lets the LLM write a Python script that calls ViloForge tools via RPC,
...
# available on every platform ViloForge itself runs on.
...
_TOOL_STUBS = {
    ...
    "write_file": (
        ...
        '"""Write content to a file (always overwrites). Returns dict with status. cross_profile=True opts out of the cross-ViloForge-profile soft guard."""',
    ...
    "patch": (
        ...
        '"""Targeted find-and-replace (mode="replace") or V4A multi-file patches (mode="patch"). Returns dict with status. cross_profile=True opts out of the cross-ViloForge-profile soft guard."""',
...
"""Auto-generated ViloForge tools RPC stubs."""
...
"""Auto-generated ViloForge tools RPC stubs (file-based transport)."""
...
def execute_code(
    ...
    to a subset of ViloForge tools.
    ...
    try:
        ...
        # HERMES_TIMEZONE is an internal ViloForge setting and must not leak
...
def build_execute_code_schema(enabled_sandbox_tools: set = None,
    ...
    description = (
        "Run a Python script that can call ViloForge tools programmatically. "
