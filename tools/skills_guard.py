...
Trust levels:
  - builtin:   Ships with ViloForge. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     ...
     "directly references ViloForge secrets file"),
    ...
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     ...
     "references ViloForge configuration files directly"),
...
# scan. `.skillignore` is the ViloForge-native name; `.clawhubignore` is honored
