#!/usr/bin/env python3
"""Build the ViloForge Model Catalog — a centralized JSON manifest of curated models.
...
ViloForge CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a ViloForge release.
